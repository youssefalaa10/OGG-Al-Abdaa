  ...
  const contactInfo = [
    {
      ...
      value: 'info@awjtech.sa',
      link: 'mailto:info@awjtech.sa',
    ...
    },
    {
      icon: MapPin,
      title: 'العنوان',
      value: 'جدة، حي الفيصلية، برج تلالين، طريق الملك فهد',
      link: '#',
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-8">
              نحن هنا لمساعدتك في تحقيق أهدافك التقنية. تواصل معنا للحصول على استشارة مجانية 
              وخطة مخصصة لمشروعك
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mr-4">أرسل لنا رسالة</h3>
                </div>
            ...
            >
              ...
              >
                <div className="h-64 bg-gradient-to-br from-primary-100 to-secondary-100 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <h4 className="text-lg font-semibold text-gray-900 mb-2">موقعنا</h4>
              ...
              >
                <h3 className="text-2xl font-bold mb-6">تابعنا على وسائل التواصل</h3>
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                answer: 'نعم، نقدم خدمات صيانة ودعم فني مستمر لجميع مشاريعنا على مدار الساعة.'
              },
              {
